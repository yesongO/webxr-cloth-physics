...
> 🔴 [요구사항]
> PC 환경에서 VR 인터랙션을 테스트하려면 
> **Chrome 확장 프로그램 Immersive Web Emulator** 설치 및 활성화가 필요합니다.
> [Immersive Web Emulator](https://chrome.google.com/webstore/detail/immersive-web-emulator/...)
